...
class UsuarioController extends Controller
{
    ...
    public function indexArtigo()
    {
        ...
        foreach ($articles as $article) {
            $localizacoes = $article->locations;
            if ($localizacoes) { // Verifique se as localizações existem antes de mesclar
                // Adicione as localizações ao array de todas as localizações
                $todasLocalizacoes = array_merge($todasLocalizacoes, $localizacoes);
            }
        }
